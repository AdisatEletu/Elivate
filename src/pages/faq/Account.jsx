  ...
  return (
    <div className={'container'}>
      ...
      <ExpandableFAQ
        ...
        description={'No need to worry! If you have lost or forgotten your password, just go to the ‘sign in’ page and then click ‘reset password’. If you’ve forgotten the email associated with your account, then please do get in touch with us by sending a mail to  support@elivate9jaonline.com or send a Direct Message to @elivate9ja_raffles on Instagram, Facebook and Twitter.        '}/>
      <ExpandableFAQ
        question={'HOW DO I DEACTIVATE THE SERVICE OR CLOSE MY ACCOUNT? '}
        description={'You can close your account at any time by accessing the ‘close account’ button at the bottom of the page or send an email to  support@elivate9jaonline.com with your registered email address and phone number with specific instructions. You can also deactivate your subscription by sending a direct message to our social media pages @elivate9ja_raffles on Instagram, Facebook and Twitter.        '}/>
      <ExpandableFAQ
      ...
      <ExpandableFAQ
        ...
        description={'You can send a mail to  support@elivate9jaonline.com or send a Direct Message to @elivate9ja_raffles on Instagram, Facebook and Twitter.        '}/>
